...
function OpenGraph({
  ...
  ...props
}: Omit<OpenGraphProps, 'corner'>) {
  const corner = { margin: 24, length: 52, strokeWidth: 1 }
    ...
    >
      <div
        style={{
          ...
          backgroundImage: `
            linear-gradient(to right, ${secondaryColor}20 1px, transparent 1px),
            linear-gradient(to bottom, ${secondaryColor}20 1px, transparent 1px)
          `,
