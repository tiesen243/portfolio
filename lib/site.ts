...
export const siteConfig: SiteConfig = {
  ...
  socials: [
    ...
    { label: 'Linkedin', href: 'https://www.linkedin.com/in/tiesen243/', icon: icons.LinkedinIcon },
    { label: 'Facebook', href: 'https://www.facebook.com/tiesen243/', icon: icons.FacebookIcon },
    { label: 'Twitter', href: 'https://twitter.com/tiesen243', icon: icons.TwitterIcon },
    { label: 'Youtube', href: 'https://www.youtube.com/@tiesen243', icon: icons.YoutubeIcon },
    { label: 'Support me', href: 'https://me.momo.vn/tiesen243', icon: icons.CoffeeIcon },
  ],
