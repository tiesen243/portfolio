...
description: Setup Hyprland OS base on Arch Linux with easy steps. Learn how to install Arch Linux with Hyprland OS on your computer and customize the system. We'll cover the basics of setting up Arch Linux, installing Hyprland OS, and configuring the system.
...
Or just change file in `~/dotfiles/assets/_background.png`

**Notes:**

1. If you need to use `obs` to record the screen, you can install the following packages
...
2. If time is not sync with windows, you can use the following command to sync the time
