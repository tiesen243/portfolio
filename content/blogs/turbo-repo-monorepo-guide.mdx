...
<Tab value="npm">```bash npx turbo login npx turbo link ```</Tab>

{' '}

<Tab value="yarn">```bash yarn turbo login yarn turbo link ```</Tab>

{' '}

<Tab value="pnpm">```bash pnpm dlx turbo login pnpm dlx turbo link ```</Tab>

{' '}

<Tab value="bun">```bash bun turbo login bun turbo link ```</Tab>
...
<Tab value="npm">```bash npm run ui-add ```</Tab>

{' '}

<Tab value="yarn">```bash yarn ui-add ```</Tab>

{' '}

<Tab value="pnpm">```bash pnpm run ui-add ```</Tab>

{' '}

<Tab value="bun">```bash bun ui-add ```</Tab>
...
<Tab value="npm">```bash npx turbo gen init ```</Tab>

{' '}

<Tab value="yarn">```bash yarn turbo gen init ```</Tab>

{' '}

<Tab value="pnpm">```bash pnpm dlx turbo gen init ```</Tab>

{' '}

<Tab value="bun">```bash bun turbo gen init ```</Tab>
