...
<Tab value="npm">```bash npx shadcn@latest add input textarea label button sonner ```</Tab>

{' '}

<Tab value="yarn">```bash npx shadcn@latest add input textarea label button sonner ```</Tab>

{' '}

<Tab value="pnpm">```bash pnpm dlx shadcn@latest add input textarea label button sonner ```</Tab>

{' '}

<Tab value="bun">```bash bunx --bun shadcn@latest add input textarea label button sonner ```</Tab>
