...
<Tabs items={["npm", "yarn", "pnpm", "bun"]}>
  ...
  <Tab value="npm">
    ```bash
    npm create next-app@latest --example https://github.com/tiesen243/create-yuki-app
    ```
  </Tab>
  ...
  <Tab value="pnpm">
    ```bash
    pnpm create next-app@latest --example https://github.com/tiesen243/create-yuki-app
    ```
  </Tab>
