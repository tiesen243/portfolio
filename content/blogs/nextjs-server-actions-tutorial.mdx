...
<Tabs items={['npm', 'yarn', 'pnpm', 'bun']}>
  ...
  <Tab value="npm">
  ```bash 
  npm create next-app@latest next-safety-server-action --example https://github.com/tiesen243/create-yuki-app
  ```
  </Tab>

  <Tab value="yarn">
  ```bash
  yarn create next-app@latest next-safety-server-action --example https://github.com/tiesen243/create-yuki-app
  ```
  </Tab>

  <Tab value="pnpm">
  ```bash
  pnpm create next-app@latest next-safety-server-action --example https://github.com/tiesen243/create-yuki-app
  ```
  </Tab>

  <Tab value="bun">
  ```bash
  bun create next-app@latest next-safety-server-action --example https://github.com/tiesen243/create-yuki-app
  ```
  </Tab>
...
```package-install
@prisma/client lucia @lucia-auth/adapter-prisma next-safe-action zod zod-form-data
```
