...
<Tab value="npm">
  ```bash npm create next-app@latest next-safety-server-action --example
...
<Tab value="yarn">
  ```bash yarn create next-app@latest next-safety-server-action --example
  https://github.com/tiesen243/create-yuki-app ```
</Tab>
...
<Tab value="pnpm">
  ```bash pnpm create next-app@latest next-safety-server-action --example
  https://github.com/tiesen243/create-yuki-app ```
</Tab>
